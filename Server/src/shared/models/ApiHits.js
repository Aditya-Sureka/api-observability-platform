...
/**
 * MongoDB schema for tracking API hits. 
 * Each document represents a single API hit event, 
 * storing relevant information such as the event ID,
 *  timestamp, service name, endpoint, HTTP method, 
 * status code, client ID, API key ID, IP address,
 *  and user agent.
 */
